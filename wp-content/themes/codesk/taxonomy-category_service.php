 ...
 */
   ...
   $sidebar_layout_config = codesk_get_option('archive_service_sidebar', 'right-sidebar'); 
   $left_sidebar = codesk_get_option('archive_service_left_sidebar', 'service_sidebar');
   $right_sidebar = codesk_get_option('archive_service_right_sidebar', 'service_sidebar');
   ...
   $columns_lg = codesk_get_option('service_columns_lg', '4');
   $columns_md = codesk_get_option('service_columns_md', '3');
   $columns_sm = codesk_get_option('service_columns_sm', '2');
   $columns_xs = codesk_get_option('service_columns_xs', '1');
