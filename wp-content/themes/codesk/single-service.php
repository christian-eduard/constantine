 ...
 */
    ...
    $default_sidebar_config = codesk_get_option('single_service_sidebar', ''); 
    $default_left_sidebar = codesk_get_option('single_service_left_sidebar', '');
    $default_right_sidebar = codesk_get_option('single_service_right_sidebar', '');
