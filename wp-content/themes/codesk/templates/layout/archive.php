 ...
 * 
 */
  $columns_lg = codesk_get_option('blog_columns_lg', '2');
  $columns_md = codesk_get_option('blog_columns_md', '2');
  $columns_sm = codesk_get_option('blog_columns_sm', '1');
  $columns_xs = codesk_get_option('blog_columns_xs', '1');

?>

<div class="clearfix">

    <?php do_action( 'codesk_page_content_before' ); ?>
    <div class="posts-grids blog-grid-style">
     ...
     <div class="pagination">
        <?php echo codesk_pagination(); ?>
     </div>
    <?php do_action( 'codesk_page_content_after' ); ?>
