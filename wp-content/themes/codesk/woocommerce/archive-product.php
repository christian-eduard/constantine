...
if ( ! defined( 'ABSPATH' ) ) exit; // Exit if accessed directly
  ...
  $sidebar_layout_config = codesk_get_option('woo_sidebar_config', '');
  $left_sidebar = codesk_get_option('woo_left_sidebar', '');
  $right_sidebar = codesk_get_option('woo_right_sidebar', '');
              ...
              <?php woocommerce_product_subcategories(); ?>  
                  ...
                  <div class="shop-loop-container">
                    <div class="gvawooaf-before-products layout-<?php echo esc_attr($woo_display) ?>">
                      ...
                      <?php do_action('codesk_woocommerce_active_filter' );  ?>
