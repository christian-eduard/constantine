...
class GVAElement_Box_Hover extends GVAElement_Base{
    ...
    public function get_title() {
        return __('GVA Box Hover', 'codesk-themer');
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            array(
                ...
                'default' => 'style-1',
                'options' => [
                  'style-1' => esc_html__('Style I - Carousel', 'codesk-themer'),
                ]
            )
         );
        $this->add_control(
            ...
            [
                ...
                'fields'      => [
                    ...
                    [
                        'name'       => 'box_image',
                        'label'      => __('Background Image', 'codesk-themer'),
                        'dynamic' => [
                          'active' => true,
                        ],
                        'default'    => [
                            'url' => GAVIAS_CODESK_PLUGIN_URL . 'elementor/assets/images/testimonial.png',
                        ],
                    ...
                    [
                        ...
                        'default'     => 'I was impresed by the codesk services, lorem ipsum is simply free text used by copytyping refreshing. Neque porro est qui dolorem ipsum quia.',
                        'label_block' => true,
                        'rows'        => '10',
                    ],
                    [
                ...
                'default'     => array(
                    array(
                        ...
                        'box_image'    => [
                            'url' => GAVIAS_CODESK_PLUGIN_URL . 'elementor/assets/images/image-4.jpg',
                        ],
                        'box_content'  => esc_html__( 'There are many variations of passages of available but the majority have suffered alter randomised words.', 'codesk-themer' ),
                    ),
                    array(
                        'box_title'  => esc_html__('Civil Rights'),
                        'box_image'    => [
                            'url' => GAVIAS_CODESK_PLUGIN_URL . 'elementor/assets/images/image-5.jpg',
                        ],
                        'box_content'  => esc_html__( 'There are many variations of passages of available but the majority have suffered alter randomised words.', 'codesk-themer' ),
                    ),
                    array(
                        ...
                        'box_image'    => [
                            'url' => GAVIAS_CODESK_PLUGIN_URL . 'elementor/assets/images/image-6.jpg',
                        ],
                        'box_content'  => esc_html__( 'There are many variations of passages of available but the majority have suffered alter randomised words.', 'codesk-themer' ),
                    ),
                    array(
        ...
        $this->add_control(
            'box_height',
            [
                'label'      => __('Box Height', 'codesk-themer'),
        ...
        $this->add_control(
            'icon_background',
            [
                'label'     => __('Icon Background Color', 'codesk-themer'),
        ...
        $this->add_control(
            'icon_border_radius',
            [
                'label'      => __('Icon Border Radius', 'codesk-themer'),
