...
class GVAElement_Search_Box extends GVAElement_Base {  
	...
	public function get_title() {
		return __( 'GVA Search Box', 'codesk-themer' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'use_icon_image',
			[
				'label' => __( 'Use Icon Image', 'codesk-themer' ),
				'type' => Controls_Manager::SWITCHER,
				'placeholder' => __( 'Use Icon Image or Icon Font', 'codesk-themer' ),
				'default' => 'yes'
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'placeholder' => __( 'fa fa-search', 'codesk-themer' ),
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					'url' => GAVIAS_CODESK_PLUGIN_URL . 'elementor/assets/images/icon.png',
				],
				'condition' => [
					'use_icon_image' => 'yes'
				]
		...
		$this->add_responsive_control(
			'icon_size',
			[
				'label' => __( 'Icon Size', 'codesk-themer' ),
		...
		$this->add_control(
			'icon_color_hover',
			[
				'label' => __( 'Color Hover', 'codesk-themer' ),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
		...
		$this->add_control(
			'icon_background',
			[
				'label' => __( 'Background', 'codesk-themer' ),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'Background Hover', 'codesk-themer' ),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
		...
		$this->add_responsive_control(
			'content_size',
			[
				'label' => __( 'Content Width', 'codesk-themer' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 200,
				],
