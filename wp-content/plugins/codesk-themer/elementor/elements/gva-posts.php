...
class GVAElement_Posts extends GVAElement_Base{
    ...
    public function get_title() {
        return __('GVA Posts', 'codesk-themer');
    }
    ...
    private function get_categories_list(){
        ...
        $categories['none'] = __( 'None', 'codesk-themer' );
        $taxonomy = 'category';
    ...
    private function get_posts() {
        ...
        $posts['none'] = __('None', 'codesk-themer');
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'section_query',
            [
                'label' => __('Query & Layout', 'codesk-themer'),
        ...
        $this->add_control(
            'category_ids',
            [
                'label' => __( 'Select By Category', 'codesk-themer' ),
        ...
        $this->add_control(
            'post_ids',
            [
                'label' => __( 'Select Individually', 'codesk-themer' ),
                'type' => Controls_Manager::SELECT2,
                'default' => '',
                'multiple'    => true,
                'label_block' => true,
        ...
        $this->add_control(
            'posts_per_page',
            [
                'label' => __( 'Posts Per Page', 'codesk-themer' ),
        ...
        $this->add_control(
            'orderby',
            [
                'label'   => __( 'Order By', 'codesk-themer' ),
                'type'    => Controls_Manager::SELECT,
                'default' => 'post_date',
                'options' => [
                    'post_date'  => __( 'Date', 'codesk-themer' ),
                    'post_title' => __( 'Title', 'codesk-themer' ),
                    'menu_order' => __( 'Menu Order', 'codesk-themer' ),
                    'rand'       => __( 'Random', 'codesk-themer' ),
                ],
            ]
        );
        ...
        $this->add_control(
            'order',
            [
                'label'   => __( 'Order', 'codesk-themer' ),
                'type'    => Controls_Manager::SELECT,
                'default' => 'desc',
                'options' => [
                    'asc'  => __( 'ASC', 'codesk-themer' ),
                    'desc' => __( 'DESC', 'codesk-themer' ),
                ],
            ]
        );
        ...
        $this->add_control( // xx Layout
         ...
         $this->add_control(
            'layout',
            [
                'label'   => __( 'Layout Display', 'codesk-themer' ),
                'type'    => Controls_Manager::SELECT,
                'default' => 'grid',
                'options' => [
                    'grid'          => __( 'Grid', 'codesk-themer' ),
                    'carousel'      => __( 'Carousel', 'codesk-themer' ),
                    'small_list'    => __( 'Small List', 'codesk-themer' )
                ]
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    'post-style-1'         => __( 'Item Post Style I', 'codesk-themer' ),
                    'post-style-2'         => __( 'Item Post Style II', 'codesk-themer' ),
                    'post-style-3'         => __( 'Item Post Style III', 'codesk-themer' ),
                ],
                'condition' => [
        ...
        $this->add_control(
            'pagination',
            [
                'label'     => __('Pagination', 'codesk-themer'),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Right List Posts Style', 'codesk-themer' ),
        ...
        $this->add_responsive_control(
            'stick_list_padding',
            [
                'label' => __( 'Padding List Posts', 'codesk-themer' ),
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Background List Posts', 'codesk-themer' ),
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'List Posts Title Color', 'codesk-themer' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'List Posts Meta Color', 'codesk-themer' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Post Content', 'codesk-themer' ),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => [
        ...
        $this->add_responsive_control(
            'post_box_padding',
            [
                'label' => __( 'Padding Post Content', 'codesk-themer' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%' ],
                'selectors' => [
        ...
        $this->add_control(
            'post_box_background',
            [
                'label' => __( 'Background Post Content', 'codesk-themer' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Post Title', 'codesk-themer' ),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'layout' => ['grid', 'carousel']
                ],
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Color Title', 'codesk-themer' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Color Title Hover', 'codesk-themer' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Post Description', 'codesk-themer' ),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'layout' => ['grid', 'carousel']
                ],
