...
class GVAElement_Tabs_Content extends GVAElement_Base {
	...
	public function get_title() {
		return __( 'GVA Tabs Content', 'codesk-themer' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_tabs',
			[
				'label' => __( 'GVA Tabs Content', 'codesk-themer' ),
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'default' => __( 'Tab Title', 'codesk-themer' ),
		...
		$this->add_control(
			'tabs',
			[
				'label' => __( 'Tabs Items', 'codesk-themer' ),
				'type' => Controls_Manager::REPEATER,
				'fields' => $repeater->get_controls(),
				'default' => [
					[
						'tab_title' => __( 'Floor 1', 'codesk-themer' ),
					...
					[
						'tab_title' => __( 'Floor 2', 'codesk-themer' ),
						'tab_content' => __( 'A fully-furnished and equipped workspace, simply turn up, plug in and get straight down to business..', 'elementor' ),
					],
					[
						'tab_title' => __( 'Floor 3', 'codesk-themer' ),
						'tab_content' => __( 'A fully-furnished and equipped workspace, simply turn up, plug in and get straight down to business..', 'elementor' ),
					],
				],
				...
				<div class="tab-content clearfix">
					<?php foreach ( $tabs as $index => $item ) :
						...
						<div <?php echo $this->get_render_attribute_string( $tab_content_setting_key ); ?>>
							<?php if($image){ ?>
								<div class="tab-image">
									<a href="<?php echo esc_url($image); ?>" class="popup-image">
							...
							<div <?php echo $this->get_render_attribute_string( $tab_content_setting_text_key ); ?>>
								<div class="tab-item-title"><?php echo $item['tab_title']; ?></div>
