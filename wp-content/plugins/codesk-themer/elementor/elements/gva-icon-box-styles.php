...
class GVAElement_Icon_Box_Styles extends GVAElement_Base {  
	...
	public function get_title() {
		return __( 'GVA Icon Box Styles', 'codesk-themer' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_icon',
			[
				'label' => __( 'GVA Icon Box Classic', 'codesk-themer' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'There are many new variations of pasages of available text.', 'codesk-themer' ),
		...
		$this->start_controls_section( //** Section Button
			'section_button',
			[
				'label' => __( 'Button & Link', 'codesk-themer' ),
			]
		);
		$this->add_control(
			'button_url',
		...
		$this->add_control(
			'use_button',
			[
				'label' => __( 'Enable Button', 'codesk-themer' ),
				'type' => Controls_Manager::SWITCHER,
				'placeholder' => __( 'Enable/Disable Button', 'codesk-themer' ),
				'default' => 'no',
				'condition' => [
					'style' => ['style-4']
				]
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .gsc-icon-box-styles .icon-box-action .btn-cta' => 'color: {{VALUE}};',
				],
				'condition' => [
					'style' => ['style-4']
				]
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .gsc-icon-box-styles .icon-box-action .btn-cta' => 'background: {{VALUE}};',
				],
				'condition' => [
					'style' => ['style-4']
				]
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .gsc-icon-box-styles .icon-box-action .btn-cta:hover' => 'color: {{VALUE}};',
				],
				'condition' => [
					'style' => ['style-4']
				]
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .gsc-icon-box-styles .icon-box-action .btn-cta:hover' => 'background: {{VALUE}};',
				],
				'condition' => [
					'style' => ['style-1']
				]
		...
		$this->start_controls_section(
			'section_box_style',
			[
				'label' => __( 'Box Style', 'codesk-themer' ),
		...
		$this->add_responsive_control(
			'box_height',
			[
				'label' => __( 'Min Height', 'codesk-themer' ),
		...
		$this->add_control(
			'icon_background',
			[
				'label' => __( 'Icon Background', 'codesk-themer' ),
				'type' => Controls_Manager::COLOR,
				'scheme' => [
					'type' => Scheme_Color::get_type(),
					'value' => Scheme_Color::COLOR_1,
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .gsc-icon-box-styles.style-1 .icon-inner .box-icon' => 'background: {{VALUE}};',
					'{{WRAPPER}} .gsc-icon-box-styles.style-2 .icon-inner .box-icon' => 'background: {{VALUE}};'
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .gsc-icon-box-styles.style-2 .icon-inner' => 'padding-right: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .gsc-icon-box-styles.style-3 .icon-inner' => 'padding-bottom: {{SIZE}}{{UNIT}};'
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .gsc-icon-box-styles.style-3 .title' => 'padding-bottom: {{SIZE}}{{UNIT}};',
				],
			]
		); 
