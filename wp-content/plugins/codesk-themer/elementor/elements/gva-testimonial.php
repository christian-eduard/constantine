...
class GVAElement_Testimonial extends GVAElement_Base{
    ...
    public function get_title() {
        return __('GVA Testimonials', 'codesk-themer');
    }
        ...
        $this->add_control(
            ...
            array(
                ...
                'options' => [
                  ...
                  'style-2' => esc_html__('Style II - Carousel Single', 'codesk-themer'),
                ]
            )
         );
        $this->add_control(
            ...
            [
                ...
                'default'     => array(
                    array(
                        'testimonial_content'  => esc_html__( 'I was impresed by the moling services, not lorem ipsum is simply free text of used by refreshing. Neque porro este qui dolorem ipsum quia.', 'codesk-themer' ),
                        'testimonial_name'     => esc_html__( 'Christine Eve', 'codesk-themer' ),
                        'testimonial_job'      => esc_html__( 'Founder & CEO', 'codesk-themer' ),
                        'testimonial_image'    => [
                            'url' => GAVIAS_CODESK_PLUGIN_URL . 'elementor/assets/images/testimonial.png',
                        ]
                    ),
                    array(
                        ...
                        'testimonial_job'      => esc_html__( 'Customer', 'codesk-themer' ),
                        'testimonial_image'    => [
                            'url' => GAVIAS_CODESK_PLUGIN_URL . 'elementor/assets/images/testimonial.png',
                        ]
                    ),
                    ...
                    array(
                        'testimonial_content'  => esc_html__( 'I was impresed by the moling services, not lorem ipsum is simply free text of used by refreshing. Neque porro este qui dolorem ipsum quia.', 'codesk-themer' ),
                        'testimonial_name'     => esc_html__( 'Susan Neill', 'codesk-themer' ),
                        'testimonial_job'      => esc_html__( 'Founder & CEO', 'codesk-themer' ),
                        'testimonial_image'    => [
                            'url' => GAVIAS_CODESK_PLUGIN_URL . 'elementor/assets/images/testimonial.png',
                        ]
