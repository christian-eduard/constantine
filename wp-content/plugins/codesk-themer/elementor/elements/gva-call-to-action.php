...
class GVAElement_Call_To_Action extends GVAElement_Base {
	...
	public function get_title() {
		return __( 'GVA Call To Action', 'codesk-themer' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
				'button-left' => esc_html__('Button Left', 'codesk-themer'),            
            'button-right' => esc_html__('Button Right', 'codesk-themer'),   
            'button-bottom' => esc_html__('Button Bottom Left', 'codesk-themer'),   
            'button-center' => esc_html__('Button Bottom Center', 'codesk-themer'),
				],
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .gsc-call-to-action.content-inner .content' => 'max-width: {{SIZE}}{{UNIT}};',
				],
			]
		);
	...
	public function wpml_widgets_to_translate_filter( $widgets ) {
		$widgets[ $this->get_name() ] = [
			...
			'fields'     => [
				[
					'field'       => 'sub_title',
					'type'        => __( 'Sub Title', 'codesk-themer' ),
					'editor_type' => 'LINE'
				],
				[
					'field'       => 'title_text',
					'type'        => __( 'Title', 'codesk-themer' ),
					'editor_type' => 'LINE'
				],
				[
					'field'       => 'description_text',
					'type'        => __( 'Description', 'codesk-themer' ),
					'editor_type' => 'LINE'
				],
			],
		];
