...
class GVAElement_List_Number extends GVAElement_Base{
    ...
    public function get_title() {
        return __('GVA List Number', 'codesk-themer');
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'section_list',
            [
                'label' => __('Number List', 'codesk-themer'),
            ]
        );
        $this->add_control(
            'style',
            ...
            [
                ...
                'fields'      => [
                    [
                        ...
                        'default'     => esc_html__('Services for a global network of creators.', 'codesk-themer'),
                        'label_block' => true,
                    ],
                    [
                        'name'    => 'content',
                        'label'   => __('Content', 'codesk-themer'),
                        'default' => esc_html__('There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration.', 'codesk-themer'),
                ...
                'default'     => array(
                    array(
                        'title'     => esc_html__('Services for a global network of creators', 'codesk-themer' ),
                        'content'  => esc_html__( 'There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration.', 'codesk-themer' )
                    ),
                    array(
        ...
        $this->add_control(
            'number_bg_color',
            [
                'label'     => __('Background Color', 'codesk-themer'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
