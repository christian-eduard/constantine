...
class GVAElement_Pricing_Block extends GVAElement_Base {
	...
	public function get_title() {
		return __( 'GVA Pricing Block', 'codesk-themer' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Standard', 'codesk-themer' ),
				'label_block' => true
			]
		);
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::TEXT,
				'placeholder' => __( 'Private amenities', 'codesk-themer' ),
				'default' => __( 'Private amenities', 'codesk-themer' ),
				'label_block' => true,
				'condition' => [
					'style' => [ 'style-2']
				]
		...
		$this->add_control(
			...
			[
				...
				'placeholder' => __( 'Your Description', 'codesk-themer' ),
				'default' => __( 'There are many new variatns of pasages of available text.', 'codesk-themer' ),
				'condition' => [
					'style' => [ 'style-2']
				]
			]
		...
		$this->add_control(
			'price',
			[
				'label' => __( 'Price', 'codesk-themer' ),
				'type' => Controls_Manager::TEXT,
				'placeholder' => __( '60.00', 'codesk-themer' ),
				'default' => __( '60.00', 'codesk-themer' ),
			]
		);
		...
		$this->add_control(
			'currency',
			[
				'label' => __( 'Currency', 'codesk-themer' ),
				'type' => Controls_Manager::TEXT,
				'placeholder' => __( 'Currency', 'codesk-themer' ),
				'default' => __( '$', 'codesk-themer' ),
			]
		);
		...
		$this->add_control(
			'period',
			[
				'label' => __( 'Period', 'codesk-themer' ),
				'type' => Controls_Manager::TEXT,
				'placeholder' => __( 'Monthly', 'codesk-themer' ),
				'default' => __( 'Monthly', 'codesk-themer' ),
			]
		);
		...
		$this->add_control(
         'pricing_content',
         [
            'label'       => __('Pricing Features', 'codesk-themer'),
            ...
            'default'     => array(
               array(
                  'pricing_features'  => esc_html__( 'High speed internet', 'codesk-themer' ),
                  'selected_icon' => array('value' => 'fas fa-check', 'library' => 'fa-solid')
               ),
               array(
                  'pricing_features'  => esc_html__( 'Free parking space', 'codesk-themer' ),
                  'selected_icon' => array('value' => 'fas fa-check', 'library' => 'fa-solid')
               ),
               array(
                  'pricing_features'  => esc_html__( 'Free parking space', 'codesk-themer' ),
               ...
               array(
                  'pricing_features'  => esc_html__( 'Full access', 'codesk-themer' ),
                  'selected_icon' => array('value' => 'fas fa-check', 'library' => 'fa-solid')
               )
            ),
         	'condition' => [
		...
		$this->start_controls_section(
			'section_price_style',
			[
				'label' => __( 'Price Text', 'codesk-themer' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
