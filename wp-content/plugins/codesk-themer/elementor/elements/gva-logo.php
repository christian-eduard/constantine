...
class GVAElement_Logo extends GVAElement_Base {
	...
	public function get_title() {
		return __( 'GVA Logo', 'codesk-themer' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'image',
			[
				'label' => __( 'Choose Logo Image', 'codesk-themer' ),
				'type' => Controls_Manager::MEDIA,
				'label_block' => true,
				'default' => [
					'url' => GAVIAS_CODESK_PLUGIN_URL . 'elementor/assets/images/logo.png',
				],
			]
		);
		$this->add_control(
		...
		$this->add_control(
			'max_width',
			[
				'label' => __( 'Max Width', 'codesk-themer' ),
		...
		$this->start_controls_section(
			'section_box_style',
			[
				'label' => __( 'Logo Styling', 'codesk-themer' ),
