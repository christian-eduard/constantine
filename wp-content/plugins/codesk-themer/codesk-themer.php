<?php 
/**
 * Plugin Name: Codesk Themer
 * Description: Open Setting, Post Type, Shortcode ... for theme 
 * Version: 1.2.0
 * Author: Gaviasthemes Team
 */

define( 'GAVIAS_CODESK_PLUGIN_URL', plugin_dir_url( __FILE__ ) );
define( 'GAVIAS_CODESK_PLUGIN_DIR', plugin_dir_path( __FILE__ )  );

class Gavias_Codesk_Themer{
	...
	public function __construct(){
      ...
      load_plugin_textdomain('codesk-themer', false, 'codesk-themer/languages/');
   ...
   public function gavias_plugin_update() {
      ...
      Puc_v4_Factory::buildUpdateChecker(
         'http://gaviasthemes.com/plugins/dummy_data/codesk-themer-update-plugin.json',
         __FILE__,
         'codesk-themer'
      );
   }
